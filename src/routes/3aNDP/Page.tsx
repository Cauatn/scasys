...
const NmSchema = z.object({
    nomeProcedimento: z
        .string()
        .nonempty('O nome do procedimento é obrigatório'),
                    ...
                    <div className="flex flex-col items-center justify-between gap-4 sm:flex sm:flex-row">
                        ...
                        >
                            ...
                            <SelectContent className="w-48">
                                <SelectItem value="Reducionista">
                                    Reducionista
                                </SelectItem>
                                <SelectSeparator />
                                <SelectItem value="Guiado">Guiado</SelectItem>
                                <SelectSeparator />
                                <SelectItem value="Expandido">
                                    Expandido
                                </SelectItem>
                                <SelectSeparator />
                                <SelectItem value="Exaustivo">
                                    Exaustivo
                                </SelectItem>
                            </SelectContent>
                        </Select>
