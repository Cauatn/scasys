...
export default function EighteenNSeg() {
	return (
		<div className="bg-white p-6 max-w-4xl m-auto h-screen space-y-8">
			...
			<div className="mx-auto px-6 py-8 max-w-xl">
				<div className="flex flex-col lg:flex-row lg:space-x-8">
					<div className="flex-1">
						...
						<div className="space-y-6">
							...
							<div className="inline-flex items-center space-x-4 justify-between w-full">
								<label
									className="text-sm font-medium text-gray-700"
									htmlFor="corrosion-rate"
								>
									Número máximo de itens de segurança empregados
								</label>
								<Input
