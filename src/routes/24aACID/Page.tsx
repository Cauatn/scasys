...
const AcidificationSchema = z.object({
    molsNumber: z.string().transform(Number),
    bibliographicSource: z.string().url(),
})

type AcidificationSchema = z.infer<typeof AcidificationSchema>

export default function TwentyFouraACD() {
    const { handleSubmit, register } = useForm({
        resolver: zodResolver(AcidificationSchema),
    })
    ...
    return (
        <div className="m-auto h-screen max-w-4xl space-y-8 bg-white p-6">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-col space-y-2">
                                    ...
                                    >
                                        número de mols gerado a cada mol de
                                        acidificante
                                    </label>
