		...
		<div className="flex flex-col gap-8 max-w-2xl m-auto mt-10 h-vh w-fit">
			<div className="inline-flex gap-9 items-center">
				<h1 className="text-2xl font-bold w-full">
					Acumulação de Compostos químicos
				</h1>
			</div>
			...
			<div className="flex flex-col gap-6">
				<div className="inline-flex gap-5 items-center justify-between">
					<div className="inline-flex space-x-3 items-center justify-between">
						<Label className="font-bold">fa: </Label>
						<TooltipProvider>
							<Tooltip>
								<TooltipTrigger>
					...
					<DropdownMenu>
						...
						<DropdownMenuContent className="w-36">
							<DropdownMenuGroup>
								<DropdownMenuItem onSelect={setItem}>BFC</DropdownMenuItem>
								<DropdownMenuSeparator />
								<DropdownMenuItem onSelect={setItem}>BFA</DropdownMenuItem>
								<DropdownMenuSeparator />
								<DropdownMenuItem onSelect={setItem}>Kow</DropdownMenuItem>
								<DropdownMenuSeparator />
								<DropdownMenuItem onSelect={setItem}>Outro</DropdownMenuItem>
							</DropdownMenuGroup>
						</DropdownMenuContent>
					</DropdownMenu>
